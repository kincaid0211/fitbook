...
2. **点击精选起点**：起点页底部提供 6 个高质量知乎问题卡片，零输入一键启动。
...
- Entry experience enhancements (2026-05-13): URL param prefill (`?url=` / `?text=`), 6 featured start cards on the start page, and a draggable Bookmarklet on the landing page for one-click exploration from any webpage.
